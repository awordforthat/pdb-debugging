...
### Task 1b - step into the function and list the context. How is this behavior different from n(ext)?
### Task 1c - rerun the example and this time s(tep) six times. What function do we end up in?

### Task 2 - Stop the code in the same place as before. Using s(tep), see if you can follow the code execution
# through all of the function calls that happen as a result of line 42 (this is similar to 1c, just in more detail).
